...
public class AimsGui_addItem extends JFrame {
    ...
    public AimsGui_addItem(Aims aims, DefaultListModel<String> itemList, int orderId, JTextArea txtTotalCost, JTextArea txtMessage) {
        ...
        btnAddTrack.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                cd = new CompactDisc(aims.getOrders().get(orderId).getItemsOrdered().size(),
                        ...
                        txtArtist.getText());
                new AimsGui_addTrack(cd, Integer.parseInt(txtNumOfTrack.getText())); // open Aims add track gui
                trackInputted = true;
            }
        });
